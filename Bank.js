...
class Bank extends React.Component {
    ...
    proses = () => {
        ...
        let bunga_awal = nominal * (bunga / 100)
        let bunga_akhir = nominal * 1 + bunga_awal
        let cicilan = bunga_akhir / periode
        ...
        return (
            <center>
                <div className="layer1">
                    ...
                    <button className="btn btn-primary" onClick={this.proses}>Hitung</button>
                    <hr />
                    <input className="form-control" name="hasil" value={"Rp. " + this.state.hasil + ",00"} disabled />
                </div>
            </center>
        );
    }
